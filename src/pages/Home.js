...
export default function HomePage() {
  return `
    ...
    <header class="relative pt-20 pb-[60px] rounded-b-xl shadow-xl overflow-hidden">
        ...
        <div class="absolute inset-0 z-10 pointer-events-none" style="background:linear-gradient(rgba(120,120,131,0.8), rgba(62,55,138,0.9));"></div>
        <div class="absolute inset-0 z-20 rounded-b-xl pointer-events-none bg-gradient-to-b from-indigo-900/60 to-gray-200/50 dark:from-gray-900/80 dark:to-black/70 transition-opacity"></div>
