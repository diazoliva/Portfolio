    ...
    <nav class="bg-white shadow-md sticky top-0 z-50 rounded-b-lg">
      <div class="container mx-auto px-6 flex justify-between items-center">
        ...
        <div class="max-xl:hidden flex items-center space-x-2-200 pl-4">
          <button class="lang-button text-sm text-gray-500 hover:text-indigo-900 px-2 cursor-pointer active" data-lang-switch="es">ES</button>
          <span class="text-gray-300">|</span>
          <button class="lang-button text-sm text-gray-500 hover:text-indigo-900 px-2 cursor-pointer" data-lang-switch="en">EN</button>
        </div>
      ...
      ` : ''}
        <div class="mt-2 pt-2 border-t border-gray-100 text-center">
          ${LANGUAGES.map(lang => `
            <button class="lang-button text-sm text-gray-500 hover:text-indigo-900 px-2 cursor-pointer ${lang.code === 'es' ? 'active' : ''}" data-lang-switch="${lang.code}">
              ${lang.name}
            </button>
